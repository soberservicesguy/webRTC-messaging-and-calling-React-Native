...
class App extends React.Component {
	constructor(props) {
		...
		// global
		this.serviceIP = 'https://webrtc-test-native-2.herokuapp.com/webrtcPeer'
	...
	// proper
	// joinRoom => makeVideoCall => getAvailableRoomMatesForPeerToPeerCall => emits 'onlinePeers' =>
	// server emits 'online-peer' => createPeerConnection => emits 'offer'


	// current
	// makeVideoCall => createPeerConnection => makeVideoCall => emits 'offer' =>
	// createPeerConnection => emits 'answer' => 


	// new
	// makeVideoCall => makeVideoCall => isPersonOnline(new) => emits 'check-online' =>
	// createPeerConnection => emits 'offer'
